...
int serializeQuest(IsarWriter writer, Quest object) {
  ...
  IsarCore.writeString(writer, 4, object.body);
...
Quest deserializeQuest(IsarReader reader) {
  ...
  final String _body;
  _body = IsarCore.readString(reader, 4) ?? '';
  final object = Quest(
    id: _id,
    name: _name,
...
class _QuestUpdateImpl implements _QuestUpdate {
  ...
  bool call({
    ...
    return collection.updateProperties([
          ...
          if (body != ignore) 4: body as String?,
        }) >
        0;
  }
}
...
extension QuestQueryFilter on QueryBuilder<Quest, Quest, QFilterCondition> {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyGreaterThan(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyGreaterThanOrEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyLessThan(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyLessThanOrEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyBetween(
    String lower,
    String upper, {
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        ContainsCondition(
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        MatchesCondition(
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const EqualCondition(
          property: 4,
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> bodyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const GreaterCondition(
          property: 4,
...
extension QuestQuerySortBy on QueryBuilder<Quest, Quest, QSortBy> {
  ...
  QueryBuilder<Quest, Quest, QAfterSortBy> sortByBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(
        4,
  ...
  QueryBuilder<Quest, Quest, QAfterSortBy> sortByBodyDesc(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(
        4,
...
extension QuestQuerySortThenBy on QueryBuilder<Quest, Quest, QSortThenBy> {
  ...
  QueryBuilder<Quest, Quest, QAfterSortBy> thenByBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterSortBy> thenByBodyDesc(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension QuestQueryWhereDistinct on QueryBuilder<Quest, Quest, QDistinct> {
  ...
  QueryBuilder<Quest, Quest, QAfterDistinct> distinctByBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension QuestQueryProperty1 on QueryBuilder<Quest, Quest, QProperty> {
  ...
  QueryBuilder<Quest, String, QAfterProperty> bodyProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension QuestQueryProperty2<R> on QueryBuilder<Quest, R, QAfterProperty> {
  ...
  QueryBuilder<Quest, (R, String), QAfterProperty> bodyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(4);
    });
  }
...
extension QuestQueryProperty3<R1, R2>
  ...
  QueryBuilder<Quest, (R1, R2, String), QOperations> bodyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(4);
    });
  }
