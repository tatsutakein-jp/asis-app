...
part of 'InsertMainQuest.req.gql.dart';
...
class _$GInsertMainQuestReq extends GInsertMainQuestReq {
  @override
  final _i3.GInsertMainQuestVars vars;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is GInsertMainQuestReq &&
        vars == other.vars &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GInsertMainQuestReq')
          ..add('vars', vars)
...
class GInsertMainQuestReqBuilder
    implements Builder<GInsertMainQuestReq, GInsertMainQuestReqBuilder> {
  _$GInsertMainQuestReq? _$v;
  ...
  GInsertMainQuestReqBuilder() {
    GInsertMainQuestReq._initializeBuilder(this);
  }

  GInsertMainQuestReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GInsertMainQuestReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GInsertMainQuestReq build() => _build();
