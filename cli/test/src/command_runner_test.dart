...
void main() {
  group('GenPackageLabelsCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late GenPackageLabelsCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = GenPackageLabelsCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = GenPackageLabelsCommandRunner();
